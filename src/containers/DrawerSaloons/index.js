...
class DrawerSaloons extends Component {
  ...
  renderFilter () {
    return (
      ...
      style={[styles.textInput, this.state.saloonNearBy == true && { backgroundColor:'#FF3600' }]}>
      ...
      <View style={styles.container}>
        <ScrollView>
          ...
          {(getSaloonNearBy.isFetching ||
           ...
           {console.log(this.state.saloonsData,'item')}
...
const action = {get_Saloon, get_Services, get_Saloon_By_Category, get_Saloon_By_Category_NearBy };
