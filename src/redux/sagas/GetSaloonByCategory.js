...
import { get_Saloon_By_Category_Api } from "../../config/WebServices";
import * as types from "../actions/ActionTypes";

import { success, failure } from "../actions/GetSaloonByCategory";
...
function callRequest(data) {
  ...
  return ApiSauce.post(get_Saloon_By_Category_Api, data);

}
function* watchRequest() {
  while (true) {
    const { payload } = yield take(types.GET_SALOON_BY_CATEGORY.REQUEST);
